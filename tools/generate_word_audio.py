...
if __name__ == "__main__":
    ...
    if ELEVENLABS_API_KEY == "sk_76a6ff0abab7acaa229121a3652cbb1ce550ea439b0efb0d":
        print("WARNING: Using embedded API key (should use environment variable)")

    if VOICE_ID == "J6Bc5DFk5HsxIQlL1hmC":
        print("WARNING: Using default voice ID (should use environment variable)")
